          ...
          <div className="flex items-center">
            {user ? (
              <div className="flex items-center gap-3">
                {console.log('🔍 Header user object:', { id: user.id, discord_id: user.discord_id, username: user.username })}
                <NavLink to={`/profile/${user.discord_id || user.id}`} className="flex items-center gap-3 rounded-lg p-1 hover:bg-slate-700/50 transition-colors">
